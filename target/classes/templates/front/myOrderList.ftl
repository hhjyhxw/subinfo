...
<html class="flex-layout">
	...
	<link rel="stylesheet" href="${pictureVisitUrl}/ldsc/css/myStyle.css?v=3">
                	...
                	<div class="modal-comfirm"  style="display: none">
                		<div class="content_zhongjiang">
                		  	<div class="content_in">
                		  		<div class="JDCardHead"><p>温馨提示：刮卡一经刮开即默认为已使用，请保管好卡号密码，丢失不再补发。
                                                        </p></div>
	...
	<script src="${pictureVisitUrl}/ldsc/js/myOrderList.js?v=5"></script>
</html>
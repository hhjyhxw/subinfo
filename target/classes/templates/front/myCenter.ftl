	...
	<body style="background: #fff; overflow: hidden;">
		<div class="flex menu">
			<div class="body" style=" width: 100%; height: 100%;">
				<div class="photo" style="background: -webkit-gradient(linear, 0 0, 0 bottom, from(#f9516a), to(#fad1a5))">
					<img src="${beanFans.headimgurl}" alt="" />
					<span class="userName"></span>
				</div>
				<div class="userInfo" style="background: url(../../ldsc/img/bg_bMenu.jpg) no-repeat 0 0;">
			...
			<ul class="bottomMenu">
				<li style="background: #ffa799;"><a href="${request.contextPath}/frontpage/beanGoods/goodsList">首页</a></li>
                <li style="background: #ffa799;"><a href="#">个人中心</a></li>
			</ul>
		</div>

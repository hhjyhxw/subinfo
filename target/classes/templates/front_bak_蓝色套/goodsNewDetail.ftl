	...
	<body style="background: #fff; overflow: scroll; -webkit-overflow-scrolling:touch;width: 100%;">
		<div class="flex">
			<div class="body">
				...
				<div class="tabsIntro">
					...
					<!--切换栏   商品详情-->
					<div class="goodsIntro" style="flex-direction: column;font-size: 28px;color: red;">
		...
		<div class="modal-comfirm cardListForm"  style="display: none">
		  	<div class="content_zhongjiang">
		  		<p class="changeLd totalneed">商品总额：${(beanGoods.score?c)!0}乐豆</p>
		  		<p class="changeLd realneed">实际需要支付：${(beanGoods.score?c)!0}乐豆</p>

		  		<!-- 一般商品，或者是非京东类商品可以使用优惠券 -->
		  		<#if (!beanGoods.beanGoodsStrategy?? || (beanGoods.beanGoodsStrategy.strategyType!='1' && beanGoods.beanGoodsStrategy.strategyType!='4'))>
                    <ul class="selectCard" style="height: 410px;overflow: auto;">
                        <li>无折扣券可用</li>
                    </ul>
		  		</#if>
...
<div class="modal-alert" style="background-color: rgba(0, 0, 0, 0.6);">
	...
	<script src="${pictureVisitUrl}/ldsc/js/goodsNewDetaill.js?v=19"></script>
</html>

...
<html class="flex-layout">
		...
		<div class="flex">
			<div class="body" style=" width: 100%; height: 100%;">
				<div class="fontPrintTab">
					<span  class="onDisplay"><i></i>话题足迹</span>
					<span><i></i>征集足迹</span>
				</div>
				<!--征集足迹-->
				<ul class="topicPrint">
				<#list page.list as foot>
				    <li>
						<a href="${request.contextPath}/frontpage/subjectTopicDetail/topicDetail?id=${foot.topicId}">
							<dl class="unitTopic">
    ...
    <script>
       $('.fontPrintTab').find('span').click(function(){
           ...
           if(index==1){
              window.location.href="${request.contextPath}/frontpage/center/collectFootPrint";
           }
       })
    </script>
</html>
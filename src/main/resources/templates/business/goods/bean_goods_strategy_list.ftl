...
<html>
	...
	<body>
		<div class="admin-main">
          <form id="form" action="${request.contextPath}/backpage/beanGoodsStrategy/list" method="post">
			<blockquote class="layui-elem-quote">
		       ...
		       <a href="javascript:;" class="layui-btn layui-btn-small" id="search">
				 ...
				 <a href="${request.contextPath}/backpage/beanGoodsStrategy/toinput" class="layui-btn layui-btn-small" id="search">
					...
					<table class="site-table table-hover">
						...
						<#list page.list as record>
						    <tr>
								...
								<td>${(record.limitNum)!''}</td>
								<td>${(record.limitTotal)!''}</td>
		...
		<script>
			...
			layui.use(['icheck', 'laypage','layer'], function() {
				...
				laypage({
					...
					jump: function(obj, first) {
						...
						if(!first) {
						 $.ajax({
				           url:'${request.contextPath}/backpage/beanGoodsStrategy/getList',
				           type:'post',
				           ...
				           success:function(data) {
                            ...
                            $.each(data.list,function(i,val){
								...
								str += '<td>'+val.limitNum+'</td>'
								str += '<td>'+val.limitTotal+'</td>'
			...
			//跳转修改
			function toEdit(id){
				window.location.href = "${request.contextPath}/backpage/beanGoodsStrategy/toinput?id="+id;
			}

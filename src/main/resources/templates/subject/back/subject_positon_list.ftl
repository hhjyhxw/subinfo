...
<html>
	...
	<body>
		<div class="admin-main">
          <form id="form" action="${request.contextPath}/backpage/subjectPositon/list" method="post">
			<blockquote class="layui-elem-quote">
		                   位置名称：<div class="layui-input-inline"><input type="text" name="positionName" value="${(record.positionName)!''}" id="positionName" /></div>
		                     位置代码：<div class="layui-input-inline"><input type="text" name="positionCode" value="${(record.positionCode)!''}" id="positionCode" /></div>
		       ...
		       <a href="javascript:;" class="layui-btn layui-btn-small" id="search">
				 ...
				 <a href="${request.contextPath}/backpage/subjectPositon/toinput" class="layui-btn layui-btn-small" id="search">
		...
		<script>
			...
			layui.use(['icheck', 'laypage','layer'], function() {
				...
				laypage({
					...
					jump: function(obj, first) {
						...
						if(!first) {
						 $.ajax({
				           url:'${request.contextPath}/backpage/subjectPositon/getList',
				           type:'post',
			...
			//跳转修改
			function toEdit(id){
				window.location.href = "${request.contextPath}/backpage/subjectPositon/toinput?id="+id;
			}

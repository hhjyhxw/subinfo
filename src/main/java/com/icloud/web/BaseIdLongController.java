...
public abstract class BaseIdLongController<T>{
	
	public final static Logger log = LoggerFactory.getLogger(BaseIdLongController.class);
	/**
	 * 列表页面
	 * @param request
	 * @return
     ...
     * @throws IOException
     */
	public abstract JSONObject getList(HttpServletRequest request,HttpServletResponse response,T t) throws Exception;
    /**
     * 去输入，增加与修改
     * @param id
     * @param request
...
//	
	 ...
	 * @return
	 */
	public abstract JSONObject input(HttpServletRequest request,HttpServletResponse response,T t)throws Exception;

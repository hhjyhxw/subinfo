...
//                sb.append(unicode_prefix).append(separator).append(hash);
//            } else {
...
//                if (sourceChar[index + 1] >= '4' && sourceChar[index + 1] <= '6' && sourceChar[index + 2] == unicode_prefix
...
//    }
//
//    public static String filter(String src, String filter) {
//        if (src == null) {
//            return null;
//        }
//        int cpCount = src.codePointCount(0, src.length());

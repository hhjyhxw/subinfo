...
public abstract class BaseController<T>{
     ...
     * @return
     */
	public abstract String toinput(Integer id,HttpServletRequest request)throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract String del(@RequestParam  Integer id,HttpServletResponse response)throws Exception;

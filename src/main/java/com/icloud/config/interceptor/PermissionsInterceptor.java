...
import com.icloud.web.util.LogUtils;
...
public class PermissionsInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(null==obj){
			response.sendRedirect("/"+ConfigUtil.get("projectname")+"/tologin");
			return false;
		}
		return true;
	...
	public void afterCompletion(HttpServletRequest request,
		...
		// 保存日志
		LogUtils.saveLog(admin, request, handler, ex, null, null, executeTime);
